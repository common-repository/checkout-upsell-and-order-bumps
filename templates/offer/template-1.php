...
<div class="cuw-offer <?php echo !empty($offer['cart_item_key']) ? 'cuw-offer-added' : ''; ?>"
    ...
    <div class="cuw-container"
        ...
        <div class="cuw-product-section" style="display: flex; gap: 8px;">
            <div class="cuw-product-image" style="width: 50%; height: auto;">
        ...
        <div class="cuw-offer-cta-section"
             style="background: #e2e6ea; text-align: center; padding: 12px; margin-top: 8px; <?php echo esc_attr($offer['styles']['cta']); ?>">
